...
l'étiquette pour faire l'entrainement supervisé. Aussi, le fait que le dataset
soit différent de l'article permet d'explorer davantage les impacts du dataset
...
- expliquer la dimension des images après le preprocessing ( 12000, 3 , 224, 224)
( Nbr d exemplaires, couleurs RGb, H, W)
TODO

\section{Discussion}
% Discussion de nos expériences. Incluant des figures, des tableaux de nos résultats.
Qu on a importe le model torch.googlenet TODO
