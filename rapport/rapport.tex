...
d’erreur le plus bas et qui est donc le plus performant. 
...
tel qu'illustré à la figure \ref{3}.
...
%    \label{3}
% \end{figure} 
% Nombre d’opérations effectuées pour réaliser cette convolution : (14×14×48) × (5×5×480) = 112.9M

Voyons maintenant le nombre d’opérations effectuées si l’on ajoute une convolution $1\times 1$ :
...
%    \label{4}
% \end{figure} 
% Nombre d’opérations effectuées : (14×14×16) × (1×1×480) + (14×14×48) × (5×5×16) = 5.3M
